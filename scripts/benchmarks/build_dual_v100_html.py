...
.tablewrap{{overflow:auto;border:1px solid var(--line);border-radius:16px;background:#091722}} table{{border-collapse:collapse;width:100%;min-width:980px;table-layout:fixed}} th,td{{padding:12px 13px;border-bottom:1px solid #173345;text-align:left;white-space:nowrap}} th{{position:sticky;top:0;background:#102737;color:#9fc0cf;font-size:11px;text-transform:uppercase;letter-spacing:.08em}} tr:hover td{{background:#0d2130}} .num{{font-variant-numeric:tabular-nums}} .hot{{color:var(--orange);font-weight:800}}
...
.tablewrap table thead th:first-child,.tablewrap table tbody td:first-child{{width:440px;min-width:300px;max-width:none;white-space:normal;word-break:break-word}}
...
(function(){{
  ...
  document.querySelectorAll('.tablewrap table').forEach(function(table, tableIndex){{
    var headers = Array.prototype.slice.call(table.querySelectorAll('thead th'));
    if (!headers.length) return;
    var storageKey = 'llm-hardware-column-widths-v1:' + tableIndex;
    var saved = {{}};
